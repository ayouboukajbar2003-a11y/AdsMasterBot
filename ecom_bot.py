...
ANTHROPIC_API_KEY = os.environ.get("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", "")
...
async def call_claude(system_prompt: str, user_message: str) -> str:
    try:
        if not ANTHROPIC_API_KEY:
            return "❌ ANTHROPIC_API_KEY ما ضيفتيهش في Railway Variables"
